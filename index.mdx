...
<CardGroup cols={2}>
  <Card title="REST API" icon="bolt" href="/api-reference/v1/schools/search/schools">
...
<CardGroup cols={2}>
  <Card
    title="Schools and Ratings"
    icon="school"
    href="/api-reference/v1/schools/search/schools"
  >
  ...
  <Card
    ...
    icon="map"
    href="/api-reference/v1/schools/search/districts"
  >
...
```bash
curl -G "https://api.ihuus.com/v1/schools/search/schools" \
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="code" href="/api-reference/v1/schools/search/schools">
