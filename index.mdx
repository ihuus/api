...
<CardGroup cols={2}>
  <Card
    ...
    icon="school"
    href="/api-reference/schools-&-ratings/schools-and-ratings"
  >
  ...
  <Card
    ...
    icon="map"
    href="/api-reference/schools-&-ratings/school-districts"
  >
...
<Tip>
  ...
  tool](/api-reference/tools/geocode-a-single-address) lets LLMs convert addresses to coordinates
...
<CardGroup cols={3}>
  ...
  <Card
    title="Walkability"
    icon="person-walking"
    href="/api-reference/vibe/walkability-score"
  >
  ...
  <Card
    title="Visual Appeal"
    icon="paintbrush"
    href="/api-reference/vibe/visual-appeal-score"
  >
  ...
  <Card
    ...
    icon="dog"
    href="/api-reference/vibe/dog-friendliness-score"
  >
...
<CardGroup cols={3}>
  <Card
    title="Noise Levels"
    icon="volume-high"
    href="/api-reference/environment/noise-levels-score"
  >
  ...
  <Card
    ...
    icon="industry"
    href="/api-reference/environment/industrial-proximity-score"
  >
...
<CardGroup cols={3}>
  <Card
    ...
    icon="shield-heart"
    href="/api-reference/demographics/health-insurance-coverage"
  >
  ...
  <Card
    ...
    icon="scale-balanced"
    href="/api-reference/demographics/ideological-lean-score"
  >
  ...
  <Card
    ...
    icon="users"
    href="/api-reference/demographics/population-age-profile"
  >
...
<CardGroup cols={2}>
  <Card
    ...
    icon="location-dot"
    href="/api-reference/tools/geocode-a-single-address"
  >
...
```bash
curl -G "https://api.ihuus.com/v1/schools/search/school_ratings" \
